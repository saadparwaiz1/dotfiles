...
_G.packer_plugins = {
  ...
  ["lspkind-nvim"] = {
    config = { "\27LJ\2\n¬\2\0\0\4\0\6\0\t6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0005\3\4\0=\3\5\2B\0\2\1K\0\1\0\15symbol_map\1\0\20\16Constructor\bÓàè\vFolder\bÔÑï\rFunction\bÔûî\15EnumMember\bÔÖù\vMethod\a∆í\rConstant\bÓà¨\tText\bÓòí\vStruct\bÔÉä\tFile\bÔÖõ\nColor\bÓà´\fSnippet\bÔ¨å\fKeyword\bÔ†Ö\tEnum\b‰∫Ü\nValue\bÔ¢ü\tUnit\bÔëµ\rProperty\bÓò§\vModule\bÔ£ñ\14Interface\bÔ∞Æ\nClass\bÓÉç\rVariable\bÓûõ\1\0\1\14with_text\2\tinit\flspkind\frequire\0" },
    loaded = false,
    needs_bufread = false,
  ...
  ["nvim-compe"] = {
    ...
    config = { "\27LJ\2\n¸\1\0\0\6\0\r\0\0176\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0005\3\4\0=\3\5\2B\0\2\0016\0\6\0009\0\a\0009\0\b\0'\2\t\0'\3\n\0'\4\v\0005\5\f\0B\0\5\1K\0\1\0\1\0\3\vsilent\2\fnoremap\2\texpr\2\25compe#close(\"<C-e>\")\n<C-e>\6i\20nvim_set_keymap\bapi\bvim\vsource\1\0\6\18snippets_nvim\2\rnvim_lua\2\rnvim_lsp\2\nspell\2\tpath\2\vbuffer\2\1\0\1\fenabled\2\nsetup\ncompe\frequire\0" },
    loaded = false,
    needs_bufread = false,
...
vim.cmd [[au FileType plaintex ++once lua require("packer.load")({'nvim-compe', 'nvim-lightbulb', 'snippets.nvim', 'lspkind-nvim', 'nvim-lspconfig'}, { ft = "plaintex" }, _G.packer_plugins)]]
vim.cmd [[au FileType lua ++once lua require("packer.load")({'nvim-compe', 'nvim-lightbulb', 'nvim-treesitter', 'snippets.nvim', 'lspkind-nvim', 'nvim-lspconfig'}, { ft = "lua" }, _G.packer_plugins)]]
vim.cmd [[au FileType c ++once lua require("packer.load")({'nvim-compe', 'nvim-lightbulb', 'snippets.nvim', 'lspkind-nvim', 'nvim-lspconfig'}, { ft = "c" }, _G.packer_plugins)]]
vim.cmd [[au FileType python ++once lua require("packer.load")({'nvim-compe', 'nvim-lightbulb', 'nvim-treesitter', 'snippets.nvim', 'lspkind-nvim', 'nvim-lspconfig'}, { ft = "python" }, _G.packer_plugins)]]
vim.cmd [[au FileType bash ++once lua require("packer.load")({'nvim-compe', 'nvim-lightbulb', 'snippets.nvim', 'lspkind-nvim', 'nvim-lspconfig'}, { ft = "bash" }, _G.packer_plugins)]]
vim.cmd [[au FileType sh ++once lua require("packer.load")({'nvim-compe', 'nvim-lightbulb', 'snippets.nvim', 'lspkind-nvim', 'nvim-lspconfig'}, { ft = "sh" }, _G.packer_plugins)]]
vim.cmd [[au FileType zsh ++once lua require("packer.load")({'nvim-compe', 'nvim-lightbulb', 'snippets.nvim', 'lspkind-nvim', 'nvim-lspconfig'}, { ft = "zsh" }, _G.packer_plugins)]]
vim.cmd [[au FileType cpp ++once lua require("packer.load")({'nvim-compe', 'nvim-lightbulb', 'snippets.nvim', 'lspkind-nvim', 'nvim-lspconfig'}, { ft = "cpp" }, _G.packer_plugins)]]
vim.cmd [[au FileType tex ++once lua require("packer.load")({'nvim-compe', 'nvim-lightbulb', 'snippets.nvim', 'lspkind-nvim', 'nvim-lspconfig'}, { ft = "tex" }, _G.packer_plugins)]]
