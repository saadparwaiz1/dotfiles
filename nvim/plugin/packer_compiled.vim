...
_G.packer_plugins = {
  ...
  ["lspkind-nvim"] = {
    config = { "\27LJ\2\n¬\2\0\0\4\0\6\0\t6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0005\3\4\0=\3\5\2B\0\2\1K\0\1\0\15symbol_map\1\0\20\vFolder\bÔÑï\vMethod\a∆í\15EnumMember\bÔÖù\tText\bÓòí\rConstant\bÓà¨\tFile\bÔÖõ\vStruct\bÔÉä\nColor\bÓà´\fSnippet\bÔ¨å\fKeyword\bÔ†Ö\tEnum\b‰∫Ü\nValue\bÔ¢ü\tUnit\bÔëµ\rProperty\bÓò§\vModule\bÔ£ñ\14Interface\bÔ∞Æ\nClass\bÓÉç\rVariable\bÓûõ\16Constructor\bÓàè\rFunction\bÔûî\1\0\1\14with_text\2\tinit\flspkind\frequire\0" },
    loaded = false,
    needs_bufread = false,
...
vim.cmd [[au FileType sh ++once lua require("packer.load")({'snippets.nvim', 'nvim-lspconfig', 'nvim-lightbulb', 'lspkind-nvim', 'nvim-compe'}, { ft = "sh" }, _G.packer_plugins)]]
vim.cmd [[au FileType lua ++once lua require("packer.load")({'nvim-treesitter', 'snippets.nvim', 'nvim-lspconfig', 'nvim-lightbulb', 'lspkind-nvim', 'nvim-compe'}, { ft = "lua" }, _G.packer_plugins)]]
vim.cmd [[au FileType cpp ++once lua require("packer.load")({'snippets.nvim', 'nvim-lspconfig', 'nvim-lightbulb', 'lspkind-nvim', 'nvim-compe'}, { ft = "cpp" }, _G.packer_plugins)]]
vim.cmd [[au FileType tex ++once lua require("packer.load")({'snippets.nvim', 'nvim-lspconfig', 'nvim-lightbulb', 'lspkind-nvim', 'nvim-compe'}, { ft = "tex" }, _G.packer_plugins)]]
vim.cmd [[au FileType c ++once lua require("packer.load")({'snippets.nvim', 'nvim-lspconfig', 'nvim-lightbulb', 'lspkind-nvim', 'nvim-compe'}, { ft = "c" }, _G.packer_plugins)]]
vim.cmd [[au FileType zsh ++once lua require("packer.load")({'snippets.nvim', 'nvim-lspconfig', 'nvim-lightbulb', 'lspkind-nvim', 'nvim-compe'}, { ft = "zsh" }, _G.packer_plugins)]]
vim.cmd [[au FileType python ++once lua require("packer.load")({'nvim-treesitter', 'snippets.nvim', 'nvim-lspconfig', 'nvim-lightbulb', 'lspkind-nvim', 'nvim-compe'}, { ft = "python" }, _G.packer_plugins)]]
vim.cmd [[au FileType bash ++once lua require("packer.load")({'snippets.nvim', 'nvim-lspconfig', 'nvim-lightbulb', 'lspkind-nvim', 'nvim-compe'}, { ft = "bash" }, _G.packer_plugins)]]
