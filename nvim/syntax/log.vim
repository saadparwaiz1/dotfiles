...
hi def link logIPV6 Label
hi def link logMacAddress Label
hi def link logFilePath GruvboxGreen
...
hi def logLevelEmergency guifg=#FB4632 guibg=NONE guisp=NONE gui=bold,italic blend=NONE
hi def logLevelAlert guifg=#FB4632 guibg=NONE guisp=NONE gui=bold,italic blend=NONE
hi def logLevelCritical guifg=#FB4632 guibg=NONE guisp=NONE gui=bold,italic blend=NONE
hi def logLevelError guifg=#FB4632 guibg=NONE guisp=NONE gui=bold,italic blend=NONE
hi def logLevelWarning guifg=#FABD2E guibg=NONE guisp=NONE gui=bold,italic blend=NONE
hi def logLevelNotice guifg=#8EC07C guibg=NONE guisp=NONE gui=bold,italic blend=NONE
hi def logLevelInfo  guifg=#83A598 guibg=NONE guisp=NONE gui=bold,italic blend=NONE
hi def logLevelDebug guifg=#FABD2E guibg=NONE guisp=NONE gui=bold,italic blend=NONE
hi def logLevelTrace guifg=#D4879C guibg=NONE guisp=NONE gui=bold,italic blend=NONE
